...
SimpleDecisionIterator::SimpleDecisionIterator(
    const genericdp::DPState<SimpleState> &state)
...
void SimpleDecisionIterator::NextTemplate() {
  ...
  template_state_.value =
      10 * template_state_.domain.investment -
      (template_state_.domain.investment * template_state_.domain.investment);
